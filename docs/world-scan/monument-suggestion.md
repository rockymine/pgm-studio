...
the author to confirm. Status: **backend complete** (`src/PgmStudio.Analysis/Suggest/MonumentSuggester.cs`);
...
provided; the scan internally adds a 2-block margin so an anchor at the box edge still resolves.
