...
43. **A refused split carries a stone (2026-09-25).** Amendment 35's "a split band carries none" read the
    ...
    composer uses). Twelve of the 120 recorded boards move, all `rot_180`, and `ComposerVersion` is
    `body-first-3` (`G271`).
