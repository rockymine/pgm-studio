...
| `FillMenu` · `FillMenuRow` | The **width→fill production rule** (§3): the `w2/w4/w6` table saying which families an interface width makes legal. `FillProfiles` composes this for the wool box. |
