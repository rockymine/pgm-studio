...
- **G34** — theming & styling rules (material palettes + prop stamps); the intended home is
  ...
  raw stone); the **prop-stamps** slice is carved out as **G161** — `docs/world-export/decoration.md` (the
  dressing pass: flora/paths/boulders/trees, prototyped in `tools/decorate/prototype.html`). G34 remains
  the umbrella for structure themes.
