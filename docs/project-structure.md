...
| `Domain` | 29 | 3,341 | flat |
| `Export` | 15 | 3,803 | flat |
...
| `Pgm` | 158 | 29,053 | `Compose/` 42 (nested) · `Authoring/` 28 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
