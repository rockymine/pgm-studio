...
|---|---|---|---|
| `Analysis` | 18 | 3,494 | `Playability/` 9 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 |
| `Api` | 90 | 11,369 | `Endpoints/` 52 · `Services/` 35 · `Http/` 2 · 1 at root |
...
| `Export` | 9 | 1,848 | flat |
| `Geom` | 45 | 5,697 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 4 · 15 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 24 | 1,577 | `Migrations/` 23 · 1 at root |
| `Minecraft` | 79 | 15,263 | `Stamping/` 16 · `Anvil/` 12 · `Palette/` 11 · `Houses/` 10 · `Render/` 9 · `Painting/` 8 · `Dressing/` 7 · `Views/` 4 · `Suggest/` 1 · 1 at root |
