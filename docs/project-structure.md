...
|---|---|---|---|
| `Analysis` | 25 | 4,518 | `Playability/` 14 · `Region/` 3 · `Suggest/` 3 · `Footprint/` 2 · `Scan/` 2 · 1 at root |
| `Api` | 111 | 15,934 | `Endpoints/` 61 · `Services/` 46 · `Http/` 3 · 1 at root |
...
| `Export` | 17 | 4,003 | flat |
| `Geom` | 50 | 6,425 | `Algorithms/` 19 · `Render/` 6 · `Relief/` 5 · 20 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 40 | 2,509 | `Migrations/` 39 · 1 at root |
| `Minecraft` | 103 | 21,254 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Dressing/` 12 · `Painting/` 12 · `Houses/` 11 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 160 | 30,725 | `Compose/` 43 (nested) · `Authoring/` 28 · `Evaluate/` 22 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
