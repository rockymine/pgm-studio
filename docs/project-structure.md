...
| `Geom` | 49 | 6,195 | `Algorithms/` 19 · `Render/` 6 · `Relief/` 5 · 19 at root |
| `Import` | 4 | 471 | flat |
...
| `Pgm` | 158 | 29,179 | `Compose/` 42 (nested) · `Authoring/` 28 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
