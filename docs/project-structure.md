...
| `Pgm` | 152 | 25,706 | `Compose/` 42 (nested) · `Authoring/` 22 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Sketch/` 10 · `Derive/` 9 · `Plan/` 8 · `Render/` 5 · `Detect/` 1 · 13 at root |
