...
| `Api` | 111 | 15,897 | `Endpoints/` 61 · `Services/` 46 · `Http/` 3 · 1 at root |
| `Client` | 212 | 26,728 | `Features/` 122 (nested) · `Components/` 71 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
...
| `Import` | 4 | 471 | flat |
| `Migrations` | 40 | 2,509 | `Migrations/` 39 · 1 at root |
| `Minecraft` | 103 | 21,253 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Dressing/` 12 · `Painting/` 12 · `Houses/` 11 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 160 | 30,709 | `Compose/` 43 (nested) · `Authoring/` 28 · `Evaluate/` 22 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
