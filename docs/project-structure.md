...
|---|---|---|---|
| `Analysis` | 21 | 3,698 | `Playability/` 11 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 91 | 11,465 | `Endpoints/` 52 · `Services/` 36 · `Http/` 2 · 1 at root |
...
| `Pgm` | 148 | 23,184 | `Compose/` 42 (nested) · `Authoring/` 21 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Derive/` 10 · `Shapes/` 10 · `Plan/` 7 · `Sketch/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
