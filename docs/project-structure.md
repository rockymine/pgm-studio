...
| `Api` | 111 | 15,864 | `Endpoints/` 61 · `Services/` 46 · `Http/` 3 · 1 at root |
| `Client` | 212 | 26,743 | `Features/` 122 (nested) · `Components/` 71 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
