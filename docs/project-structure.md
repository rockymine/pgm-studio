...
| `Api` | 87 | 10,575 | `Endpoints/` 49 · `Services/` 35 · `Http/` 2 · 1 at root |
| `Client` | 188 | 23,105 | `Features/` 109 (nested) · `Components/` 60 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 31 | 2,866 | flat |
