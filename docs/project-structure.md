...
| `Domain` | 28 | 3,302 | flat |
| `Export` | 15 | 3,754 | flat |
...
| `Pgm` | 157 | 28,807 | `Compose/` 42 (nested) · `Authoring/` 27 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
