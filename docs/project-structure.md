...
|---|---|---|---|
| `Analysis` | 25 | 4,551 | `Playability/` 14 · `Region/` 3 · `Suggest/` 3 · `Footprint/` 2 · `Scan/` 2 · 1 at root |
...
| `Domain` | 28 | 3,258 | flat |
| `Export` | 15 | 3,578 | flat |
| `Geom` | 49 | 6,098 | `Algorithms/` 19 · `Render/` 6 · `Relief/` 5 · 19 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 39 | 2,478 | `Migrations/` 38 · 1 at root |
| `Minecraft` | 101 | 20,775 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Painting/` 12 · `Houses/` 11 · `Dressing/` 10 · `Views/` 4 · `Suggest/` 1 · 1 at root |
