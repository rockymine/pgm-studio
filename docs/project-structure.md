...
|---|---|---|---|
| `Analysis` | 18 | 3,513 | `Playability/` 9 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 |
| `Api` | 90 | 11,355 | `Endpoints/` 52 · `Services/` 35 · `Http/` 2 · 1 at root |
...
| `Export` | 9 | 1,798 | flat |
| `Geom` | 45 | 5,622 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 4 · 15 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 24 | 1,577 | `Migrations/` 23 · 1 at root |
| `Minecraft` | 79 | 15,260 | `Stamping/` 16 · `Anvil/` 12 · `Palette/` 11 · `Houses/` 10 · `Render/` 9 · `Painting/` 8 · `Dressing/` 7 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 148 | 23,186 | `Compose/` 42 (nested) · `Authoring/` 21 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Derive/` 10 · `Shapes/` 10 · `Plan/` 7 · `Sketch/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
