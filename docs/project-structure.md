...
| `Api` | 109 | 15,517 | `Endpoints/` 60 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 208 | 25,962 | `Features/` 119 (nested) · `Components/` 70 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,559 | flat |
...
| `Import` | 4 | 471 | flat |
| `Migrations` | 34 | 2,096 | `Migrations/` 33 · 1 at root |
...
| `Pgm` | 154 | 26,934 | `Compose/` 42 (nested) · `Authoring/` 24 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
