...
|---|---|---|---|
| `Analysis` | 21 | 3,778 | `Playability/` 11 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 91 | 11,472 | `Endpoints/` 52 · `Services/` 36 · `Http/` 2 · 1 at root |
| `Client` | 188 | 23,108 | `Features/` 109 (nested) · `Components/` 60 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 31 | 2,888 | flat |
| `Data` | 14 | 2,460 | `Features/` 4 · `Map/` 4 · `Theme/` 3 · `Schema/` 2 · `Plan/` 1 |
| `Domain` | 26 | 2,552 | flat |
| `Export` | 9 | 1,900 | flat |
| `Geom` | 46 | 5,561 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 5 · 15 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 24 | 1,577 | `Migrations/` 23 · 1 at root |
| `Minecraft` | 79 | 15,390 | `Stamping/` 16 · `Anvil/` 12 · `Palette/` 11 · `Houses/` 10 · `Render/` 9 · `Painting/` 8 · `Dressing/` 7 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 147 | 23,060 | `Compose/` 42 (nested) · `Authoring/` 21 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 7 · `Sketch/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
