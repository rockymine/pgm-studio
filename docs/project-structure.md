...
| `Api` | 111 | 15,868 | `Endpoints/` 61 · `Services/` 46 · `Http/` 3 · 1 at root |
...
| `Minecraft` | 103 | 21,311 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Dressing/` 12 · `Painting/` 12 · `Houses/` 11 · `Views/` 4 · `Suggest/` 1 · 1 at root |
