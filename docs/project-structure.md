...
| `Api` | 108 | 15,178 | `Endpoints/` 59 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 206 | 25,631 | `Features/` 117 (nested) · `Components/` 70 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,463 | flat |
...
| `Minecraft` | 95 | 19,626 | `Stamping/` 16 · `Render/` 15 · `Anvil/` 13 · `Palette/` 13 · `Painting/` 12 · `Dressing/` 10 · `Houses/` 10 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 154 | 26,856 | `Compose/` 42 (nested) · `Authoring/` 23 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Sketch/` 10 · `Derive/` 9 · `Plan/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
