...
| `Domain` | 30 | 3,451 | flat |
| `Export` | 16 | 3,918 | flat |
| `Geom` | 50 | 6,399 | `Algorithms/` 19 · `Render/` 6 · `Relief/` 5 · 20 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 39 | 2,478 | `Migrations/` 38 · 1 at root |
| `Minecraft` | 102 | 21,178 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Painting/` 12 · `Dressing/` 11 · `Houses/` 11 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 160 | 30,639 | `Compose/` 43 (nested) · `Authoring/` 28 · `Evaluate/` 22 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
