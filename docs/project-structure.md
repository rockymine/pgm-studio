...
| `Geom` | 51 | 6,182 | `Algorithms/` 21 · `Render/` 6 · `Relief/` 5 · 19 at root |
| `Import` | 4 | 471 | flat |
...
| `Pgm` | 154 | 26,692 | `Compose/` 42 (nested) · `Authoring/` 23 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Sketch/` 10 · `Derive/` 9 · `Plan/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
