...
|---|---|---|---|
| `Analysis` | 21 | 3,837 | `Playability/` 11 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 91 | 11,662 | `Endpoints/` 52 · `Services/` 36 · `Http/` 2 · 1 at root |
...
| `Export` | 9 | 1,911 | flat |
| `Geom` | 48 | 5,681 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 5 · 17 at root |
| `Import` | 4 | 471 | flat |
