...
|---|---|---|---|
| `Analysis` | 21 | 3,693 | `Playability/` 11 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 · 1 at root |
...
| `Export` | 9 | 1,848 | flat |
| `Geom` | 45 | 5,631 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 4 · 15 at root |
| `Import` | 4 | 471 | flat |
...
| `Pgm` | 148 | 23,209 | `Compose/` 42 (nested) · `Authoring/` 21 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Derive/` 10 · `Shapes/` 10 · `Plan/` 7 · `Sketch/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
