...
|---|---|---|---|
| `Analysis` | 18 | 3,538 | `Playability/` 9 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 |
| `Api` | 90 | 11,375 | `Endpoints/` 52 · `Services/` 35 · `Http/` 2 · 1 at root |
...
| `Export` | 9 | 1,848 | flat |
| `Geom` | 45 | 5,708 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 4 · 15 at root |
| `Import` | 4 | 471 | flat |
