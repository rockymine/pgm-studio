...
|---|---|---|---|
| `Analysis` | 21 | 3,847 | `Playability/` 11 · `Region/` 3 · `Footprint/` 2 · `Layer/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 91 | 11,664 | `Endpoints/` 52 · `Services/` 36 · `Http/` 2 · 1 at root |
...
| `Export` | 9 | 1,918 | flat |
| `Geom` | 48 | 5,653 | `Algorithms/` 20 · `Relief/` 6 · `Render/` 5 · 17 at root |
| `Import` | 4 | 471 | flat |
...
| `Pgm` | 148 | 23,419 | `Compose/` 42 (nested) · `Authoring/` 21 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Sketch/` 8 · `Plan/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
