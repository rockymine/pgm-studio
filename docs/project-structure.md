...
| `Api` | 110 | 15,695 | `Endpoints/` 61 · `Services/` 45 · `Http/` 3 · 1 at root |
...
| `Pgm` | 158 | 29,515 | `Compose/` 42 (nested) · `Authoring/` 28 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
