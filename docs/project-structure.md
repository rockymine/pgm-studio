...
|---|---|---|---|
| `Analysis` | 25 | 4,567 | `Playability/` 14 · `Region/` 3 · `Suggest/` 3 · `Footprint/` 2 · `Scan/` 2 · 1 at root |
| `Api` | 111 | 15,937 | `Endpoints/` 61 · `Services/` 46 · `Http/` 3 · 1 at root |
| `Client` | 194 | 24,325 | `Features/` 114 (nested) · `Components/` 63 (nested) · `Pages/` 7 · `Models/` 4 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,699 | flat |
| `Data` | 17 | 2,979 | `Features/` 5 · `Map/` 5 · `Theme/` 4 · `Schema/` 2 · `Plan/` 1 |
| `Domain` | 30 | 3,463 | flat |
| `Export` | 17 | 4,004 | flat |
| `Geom` | 50 | 6,425 | `Algorithms/` 19 · `Render/` 6 · `Relief/` 5 · 20 at root |
| `Import` | 4 | 472 | flat |
| `Migrations` | 41 | 2,541 | `Migrations/` 40 · 1 at root |
| `Minecraft` | 103 | 21,282 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Dressing/` 12 · `Painting/` 12 · `Houses/` 11 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 160 | 30,756 | `Compose/` 43 (nested) · `Authoring/` 28 · `Evaluate/` 22 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
