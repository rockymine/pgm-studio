...
| `Import` | 4 | 471 | flat |
| `Migrations` | 37 | 2,296 | `Migrations/` 36 · 1 at root |
...
| `Pgm` | 154 | 27,068 | `Compose/` 42 (nested) · `Authoring/` 24 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
