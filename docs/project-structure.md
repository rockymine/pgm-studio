...
| `Api` | 110 | 15,632 | `Endpoints/` 61 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 209 | 26,205 | `Features/` 119 (nested) · `Components/` 71 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,620 | flat |
| `Data` | 17 | 2,769 | `Features/` 5 · `Map/` 5 · `Theme/` 4 · `Schema/` 2 · `Plan/` 1 |
| `Domain` | 27 | 2,860 | flat |
| `Export` | 14 | 3,377 | flat |
| `Geom` | 52 | 6,590 | `Algorithms/` 22 · `Render/` 6 · `Relief/` 5 · 19 at root |
| `Import` | 4 | 471 | flat |
| `Migrations` | 35 | 2,144 | `Migrations/` 34 · 1 at root |
| `Minecraft` | 98 | 20,006 | `Stamping/` 16 · `Palette/` 15 · `Render/` 15 · `Anvil/` 13 · `Painting/` 12 · `Houses/` 11 · `Dressing/` 10 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 154 | 26,984 | `Compose/` 42 (nested) · `Authoring/` 24 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
