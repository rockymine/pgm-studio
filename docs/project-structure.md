...
|---|---|---|---|
| `Analysis` | 24 | 4,180 | `Playability/` 14 · `Region/` 3 · `Footprint/` 2 · `Scan/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 108 | 15,046 | `Endpoints/` 59 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 206 | 25,019 | `Features/` 117 (nested) · `Components/` 70 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,431 | flat |
| `Data` | 16 | 2,647 | `Map/` 5 · `Features/` 4 · `Theme/` 4 · `Schema/` 2 · `Plan/` 1 |
| `Domain` | 26 | 2,832 | flat |
| `Export` | 14 | 3,250 | flat |
| `Geom` | 51 | 6,387 | `Algorithms/` 21 · `Render/` 6 · `Relief/` 5 · 19 at root |
| `Import` | 4 | 471 | flat |
