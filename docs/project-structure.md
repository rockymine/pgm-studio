...
| `Api` | 96 | 13,213 | `Endpoints/` 54 · `Services/` 38 · `Http/` 3 · 1 at root |
...
| `Pgm` | 151 | 25,289 | `Compose/` 42 (nested) · `Authoring/` 22 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Sketch/` 9 · `Plan/` 8 · `Render/` 5 · `Detect/` 1 · 13 at root |
