...
| `Api` | 91 | 12,035 | `Endpoints/` 52 · `Services/` 36 · `Http/` 2 · 1 at root |
| `Client` | 203 | 23,604 | `Features/` 117 (nested) · `Components/` 67 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
...
| `Minecraft` | 85 | 16,595 | `Stamping/` 16 · `Anvil/` 13 · `Palette/` 12 · `Houses/` 10 · `Painting/` 10 · `Dressing/` 9 · `Render/` 9 · `Views/` 4 · `Suggest/` 1 · 1 at root |
| `Pgm` | 150 | 24,255 | `Compose/` 42 (nested) · `Authoring/` 22 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Sketch/` 9 · `Plan/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
