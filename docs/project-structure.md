...
| `Api` | 110 | 15,738 | `Endpoints/` 61 · `Services/` 45 · `Http/` 3 · 1 at root |
...
| `Domain` | 30 | 3,433 | flat |
| `Export` | 15 | 3,847 | flat |
...
| `Pgm` | 160 | 30,323 | `Compose/` 43 (nested) · `Authoring/` 28 · `Evaluate/` 22 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
