...
| `Api` | 110 | 15,691 | `Endpoints/` 61 · `Services/` 45 · `Http/` 3 · 1 at root |
...
| `Minecraft` | 101 | 20,831 | `Palette/` 17 · `Stamping/` 17 · `Render/` 15 · `Anvil/` 13 · `Painting/` 12 · `Houses/` 11 · `Dressing/` 10 · `Views/` 4 · `Suggest/` 1 · 1 at root |
