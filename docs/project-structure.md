...
|---|---|---|---|
| `Analysis` | 24 | 4,134 | `Playability/` 14 · `Region/` 3 · `Footprint/` 2 · `Scan/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 93 | 12,184 | `Endpoints/` 52 · `Services/` 37 · `Http/` 3 · 1 at root |
| `Client` | 201 | 23,882 | `Features/` 115 (nested) · `Components/` 67 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 31 | 3,008 | flat |
...
| `Pgm` | 150 | 24,725 | `Compose/` 42 (nested) · `Authoring/` 22 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Sketch/` 9 · `Plan/` 7 · `Render/` 5 · `Detect/` 1 · 13 at root |
