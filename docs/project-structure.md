...
|---|---|---|---|
| `Analysis` | 24 | 4,295 | `Playability/` 14 · `Region/` 3 · `Footprint/` 2 · `Scan/` 2 · `Suggest/` 2 · 1 at root |
| `Api` | 109 | 15,563 | `Endpoints/` 60 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 209 | 26,205 | `Features/` 119 (nested) · `Components/` 71 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,576 | flat |
