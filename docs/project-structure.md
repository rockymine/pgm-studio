...
| `Client` | 208 | 25,961 | `Features/` 119 (nested) · `Components/` 70 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,559 | flat |
| `Data` | 16 | 2,686 | `Map/` 5 · `Features/` 4 · `Theme/` 4 · `Schema/` 2 · `Plan/` 1 |
| `Domain` | 27 | 2,860 | flat |
| `Export` | 14 | 3,373 | flat |
...
| `Pgm` | 154 | 26,931 | `Compose/` 42 (nested) · `Authoring/` 24 · `Evaluate/` 21 (nested) · `Editing/` 11 · `Shapes/` 10 · `Derive/` 9 · `Plan/` 9 · `Sketch/` 9 · `Render/` 5 · `Detect/` 1 · 13 at root |
