...
| `Api` | 109 | 15,551 | `Endpoints/` 60 · `Services/` 45 · `Http/` 3 · 1 at root |
| `Client` | 209 | 26,204 | `Features/` 119 (nested) · `Components/` 71 (nested) · `Pages/` 7 · `Models/` 6 · `Layout/` 3 · 3 at root |
| `Contracts` | 33 | 3,568 | flat |
