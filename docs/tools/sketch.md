...
a boulder is bedded into the ground it stands on, how a tree is copied or grown, and how a channel is dug. Two of those reach
...
sky-lit faces, and `rock`, a full terrain material like a stroke's paving. A rock's material resolves in the **boulder's own frame** rather than the map's, so a
