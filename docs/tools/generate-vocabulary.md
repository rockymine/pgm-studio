...
`generate.md` **§1** defines the abstract *terms* (family, interface, width, budget…); `generate.md`
...
The pipeline these are ordered along (from `generate.md` §2):
