...
- `canvas-interaction.md` §10 — the canvas primitive palette (a different, canvas-side visual system);
  `render/primitive-style.js` is the shared helper that decides it.
