...
// The layout DERIVER, first cut (docs/generator/evaluator.md §5). Reads the authored seed corpus
    ...
    *{ box-sizing:border-box; } html,body{ margin:0; padding:0; }
    ...
    <div class="wrap">
      <header class="top">
        ...
        Disagreements are the cutoff test set. Per <code>docs/generator/evaluator.md</code> §5.</p>
        {legend}
      </header>
