...
Curated `*.plan.json` examples that exist **only to inform `docs/generator/rules.md`** — do's and
...
dead-ends are allowed. Each authored set feeds a `docs/generator/rules.md` amendment via the
correction protocol.
