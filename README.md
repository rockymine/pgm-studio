...
New here? [`docs/setup-guide.md`](docs/setup-guide.md) walks through installing and running the
studio on Windows, Linux, or macOS. The rest of this README is a reference for people already set up.
