...
| `pgm/` | the map contract — destroyables/cores, control points, water lanes, regions and filters, include resolution, what the studio refuses to read, the intent model, `template.xml`. |
