...
export async function mount(svgEl, wrapEl, cursorEl, dotnetRef) {
  ...
  // Toggle a wall mark on a land-interface piece pair, then re-run the live feeds immediately so the heavy
  // bar and its chest-face tick (and the "not an interface" error, if the pair stops sharing a seam) refresh
