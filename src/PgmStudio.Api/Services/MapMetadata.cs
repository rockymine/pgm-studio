...
///
/// <para><b>An author named here is named in the map's intent too</b>, where the map holds one — both writes
/// are <see cref="MapAuthors"/>'s and it states why they travel together. The traffic already ran the other
/// way, an intent write resolving its names into the rows; this is the return leg.</para>
/// </summary>
