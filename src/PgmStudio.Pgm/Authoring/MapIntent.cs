...
/// <para>What a board says about the void is that boundary and nothing else: the generator wires one rule,
/// over the ground outside the buildable region, in the shape <c>docs/pgm/template.xml</c> writes.</para></summary>
