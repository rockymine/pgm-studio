...
/// <summary>How the intervals of one offer group may be consumed (docs/generator/model.md §1.14 — the
...
/// <summary>
/// An <b>offer</b> (docs/generator/model.md §1.14) — the outward constraint a designation publishes:
