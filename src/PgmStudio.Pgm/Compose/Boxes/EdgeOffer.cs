...
/// <summary>How the intervals of one offer group may be consumed (docs/tools/generate.md §1.14 — the
...
/// <summary>
/// An <b>offer</b> (docs/tools/generate.md §1.14) — the outward constraint a designation publishes:
