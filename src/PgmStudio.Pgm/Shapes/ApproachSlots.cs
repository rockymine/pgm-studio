...
/// layers are conflated here, split conceptually per <c>docs/tools/generate.md</c> §8:
///
...
/// rectangle in different slots. See the piece vocabulary in <c>docs/tools/generate.md</c> §5.</summary>
