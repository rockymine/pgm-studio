...
/// box (docs/tools/generate.md §1.12). <see cref="Approach"/> stamps an <c>entry</c> and a
...
/// (generate.md §1.12, §5.3). <see cref="Interface"/> is a hub edge that sources a per-edge width a
