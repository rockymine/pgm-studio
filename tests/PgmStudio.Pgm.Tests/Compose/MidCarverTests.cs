...
public sealed class MidCarverTests
{
    ...
    {
        var env = new ComposeEnvelope(symmetry, Teams: 2, PlayersPerTeam: 12, Band: SizeBands.Nano, Cell: 5,
            Surface: 9, CorridorCells: 2, WoolCorridorCells: 2, BoardWidthBlocks: 300, BoardLengthBlocks: 300, LandPerTeam: 2800,
    ...
    {
        var h = MidCarver.BandOnly(new ComposeEnvelope("rot_180", 2, 12, SizeBands.Nano, 5, 9, 2, 2, 300, 300, 2800, -40, -40, 40, 40))
            .HalfGapCells;
    ...
    {
        var h = MidCarver.BandOnly(new ComposeEnvelope("mirror_z", 2, 12, SizeBands.Nano, 5, 9, 2, 2, 300, 300, 2800, -40, -40, 40, 40))
            .HalfGapCells;
        var face = Unit(h, (-5, 3), (2, 3));
