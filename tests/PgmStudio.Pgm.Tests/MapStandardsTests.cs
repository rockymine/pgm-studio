    ...
    private static MapXml MapWithKit() => new()
    {
        ...
        [
            new Kit
            {
                ...
                Items =
                [
                    new KitItem { Slot = 0, Item = new() { Material = "iron sword" } },
                    new KitItem { Slot = 1, Item = new() { Material = "bow" } },
                    new KitItem { Slot = 2, Item = new() { Material = "iron pickaxe" } },
                    new KitItem { Slot = 3, Item = new() { Material = "iron axe" } },
                    new KitItem { Slot = 4, Item = new() { Material = "iron spade" } },
                    new KitItem { Slot = 5, Item = new() { Material = "shears" } },
                    new KitItem { Slot = 6, Item = new() { Material = "golden apple" } },
                    new KitItem { Slot = 7, Item = new() { Material = "wood", Amount = 64 } },
                    new KitItem { Slot = 8, Item = new() { Material = "arrow" } },
                    new KitItem { Slot = 9, Item = new() { Material = "stained clay", Amount = 32, TeamColor = true } },
                ],
                Armor =
                [
                    new KitArmor { SlotName = "helmet", Item = new() { Material = "leather helmet" } },
                    new KitArmor { SlotName = "chestplate", Item = new() { Material = "leather chestplate" } },
                    new KitArmor { SlotName = "leggings", Item = new() { Material = "chainmail leggings" } },
                    new KitArmor { SlotName = "boots", Item = new() { Material = "leather boots" } },
                ],
            },
        ],
    };
