...
public sealed class BuildCeilingTests
{
    ...
    private const string Stepped =
        """
        {"setup":{"mirror_mode":"rot_180","center":{"cx":0,"cz":0}},"layers": [{ "id": "ground", "base_y": 0, "layout":{"shapes":[{"id":"a","type":"rectangle","operation":"add","min_x":-40,"min_z":-40,"max_x":40,"max_z":40,"base_height":1},{"id":"b","type":"rectangle","operation":"add","min_x":-10,"min_z":-10,"max_x":10,"max_z":10,"base_height":31}],"islands":[]} }]}
        """;
