...
The question these were run to answer is settled: the studio does not classify finished maps, and
the rule is stated in docs/generator/model.md §4.7. They are kept as the instrument that produced
that answer, not as a live harness.
"""
import json, glob, os
